...
SOUNDS = ['sounds/alert.mp3', 'sounds/attention.mp3', 'sounds/bark.wav', 'sounds/wakeup.mp3']
    ...
    while True:
        ...
        if not success:
            ...
            if pause == True:
                ...
                if results.multi_face_landmarks:
                    for face_landmarks in results.multi_face_landmarks:
                        ...
                        if frame_count_2 > min_frame:
                            ...
                            # except:
                            #     print('error')
                            if (frame_count_2 % 30 == 0):
                                t = threading.Thread(target=playsounds)
                                t.start()
                ...
                if success and frame_count_2 <= min_frame:
                    image.flags.writeable = False
...
def playsounds():
    file = SOUNDS[random.randint(0, 3)]
    playsound(file)
